                ...
                <form id="myform1" name="form1" method="post" class="row g-3" action=db_general.php novalidate>
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-md-2">
                                <label for="sid" class="form-label">เลขที่</label>
                                <input readonly required class="form-control" id="sid" name="sid">
                            </div>
                            <div class="col">
                    ...
                    <div class="modal-footer">
                        <a href="manage_status" class="btn btn-secondary">กลับ</a>
                    ...
                    <div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">ข้อมูลสถานะ</h4>
                            </div>
                            <div class="row">
                                <div class="card-body">
