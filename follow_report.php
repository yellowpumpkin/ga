...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myform1" name="form1" method="post" class="row g-3" action=db_general.php>
                        <div class="modal-body" id="detail">

                        </div>
                        <div class="modal-footer">
                            <a href="manage_maintenance" class="btn btn-secondary">กลับ</a>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">
                                    แจ้งปัญหาการใช้พื้นที่/อุปกรณ์/สิ่งอำนวยความสะดวกส่วนกลาง </h4>
                            </div>
                                    ...
                                    <table id="myTable" class="display" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                    ...
                                                    where case_status = '0' and sid > '1' and sid < '4'
                                                    ");
                                                    $select_stmt->execute();
    ...
    $(document).on('click', '.edit_data', function() {
        ...
        console.log(case_id);
        $.ajax({
            url: "display_update_status_report.php",
            method: "post",
            data: {
                id: case_id
            },
